...
function main() {
    ...
    const summary = {
        ...
        contentMediaArticleCount: bundle.contentMedia.records.length,
        contentMediaAssetCount: bundle.contentMedia.assets.length,
        contentMediaBytes: bundle.contentMedia.totalBytes,
        catalogPlacement,
