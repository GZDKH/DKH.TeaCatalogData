...
- [x] Add AdminGateway REST transport for catalog-source publication.
- [x] Bind REST publication envelopes to storefront/catalog scope.
- [x] Preserve legacy gRPC transport for diagnostics.
- [x] Update durable receipt metadata for REST transport.
